...
from base.scheduler.tasks import task_fetch_derivatives
from base.store.daily_repo import get_by_code
from base.store.derivatives_repo import (
    get_basis_latest_date,
    get_basis_series,
    get_pcr_latest_date,
    get_pcr_series,
)
from derivatives.analysis.divergence import FUTURES_PROXY, compute_divergence
