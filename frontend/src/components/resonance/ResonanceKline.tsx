...
export default function ResonanceKline({ kline, history, signals, trades, dangerZone, selectedDate, onSelectDate, dateWindow, onZoomChange, bridge }: {
  kline: KlinePoint[]
  ...
  const { option, dates } = useMemo(() =>
    buildKlineOption({ kline, history, signals, trades, dangerZone, selectedDate, rangeSel, rangeStats, isMobile }),
  [kline, signals, history, trades, dangerZone, selectedDate, rangeSel, rangeStats, isMobile])
